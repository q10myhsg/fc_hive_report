...
public class RingConfig {
	...
	public static Logger logger = Logger.getLogger(RingConfig.class.getName());//写控制台
	public static String default_config ="./hive_conf/config_hive.properties";//默认属性文件名称
	public static Properties mConfig = null;
	...
	public static void startConfig(){
		String struts_cl = RingConfig.class.getResource("/").getPath();
		 ...
		 try{
			 ...
			 logger.info("配置文件路径："+struts_cl+default_config);
